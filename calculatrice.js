function Calculator()
{
  ...
  {
    var numbers = $(this.field).val().split(symbol), //split permet de separons nos symbol sous forme de tableau
      result;
    ...
    if (symbol == "-")
      result = numbers[0] - numbers[1];
    if (symbol == "+")
      result = parseFloat(numbers[0]) + parseFloat(numbers[1]);  //parseFloat permet de contourner le probleme de concatenation
